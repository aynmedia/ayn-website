        ...
        <div className='max-w-7xl mx-4 md:mx-auto py-4 text-white flex flex-col md:flex-row gap-2'>
          <div className='w-full md:w-1/3 gap-y-12 flex flex-col'>
            ...
            <p className='text-gray-400 font-medium text-lg'>
              ...
              marketing agency based in Chennai, India. With a team of over 40+,
              we are an award-winning full-stack digital marketing agency
          ...
          <div className='w-full md:w-1/3 flex flex-col gap-y-6'>
            ...
            <p className='text-gray-400 font-medium text-lg'>+91-89259 22232</p>
            <p className='text-gray-400 font-medium text-lg'>info@ayntech.in</p>
